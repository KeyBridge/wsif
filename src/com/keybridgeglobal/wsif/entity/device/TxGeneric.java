...
/**
 * <p>Java class for txGeneric complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="txGeneric">
 *   &lt;complexContent>
 *     &lt;extension base="{}device">
 *       &lt;sequence>
 *         &lt;element name="channelList" type="{}channel" maxOccurs="unbounded"/>
 *         &lt;element name="receiverList" type="{}device" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "txGeneric", propOrder = {
    "channelList",
    "receiverList"
})
public class TxGeneric
    extends Device
{

    @XmlElement(required = true)
    protected List<Channel> channelList;
    protected List<Device> receiverList;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the receiverList property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getReceiverList().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     *
     */
    public List<Device> getReceiverList() {
        if (receiverList == null) {
            receiverList = new ArrayList<Device>();
        }
