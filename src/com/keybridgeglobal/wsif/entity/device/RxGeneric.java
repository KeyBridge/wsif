...
/**
 * <p>Java class for rxGeneric complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="rxGeneric">
 *   &lt;complexContent>
 *     &lt;extension base="{}device">
 *       &lt;sequence>
 *         &lt;element name="channelList" type="{}channel" maxOccurs="unbounded"/>
 *         &lt;element name="transmitterList" type="{}device" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "rxGeneric", propOrder = {
    "channelList",
    "transmitterList"
})
public class RxGeneric
    extends Device
{

    @XmlElement(required = true)
    protected List<Channel> channelList;
    protected List<Device> transmitterList;
    ...
    /**
     * Gets the value of the transmitterList property.
     *
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the transmitterList property.
     *
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getTransmitterList().add(newItem);
     * </pre>
     *
     *
     * <p>
     ...
     *
     */
    public List<Device> getTransmitterList() {
        if (transmitterList == null) {
            transmitterList = new ArrayList<Device>();
        }
